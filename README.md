...
| Template | Best For |
|----------|----------|
| [Web App](./templates/web-app/CLAUDE.md) | Next.js / React projects |
| [Backend API](./templates/backend-api/CLAUDE.md) | Node.js / Python REST/GraphQL APIs |
| [CLI Tool](./templates/cli-tool/CLAUDE.md) | npm/pip publishable CLI tools and libraries |
